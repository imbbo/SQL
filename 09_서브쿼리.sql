...
-- employee_id 가 103번인 사람과 job_id가 동일한 사람을 검색하는 문장.
...
-- 해결: 정렬이 미리 진행된 자료에 ROWNUM을 붙여서 다시 조회하는 것을 추천
...
-- 이유: WHERE절부터 먼저 실행하고 나서 ROWNUM이 SELECT 되기 떄문에.

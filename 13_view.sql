...
뷰를 통해서 데이터에 접근하면 원본 데이터는 안전하게 보호될수 있습니다.
*/
...
-- 복합 뷰
-- 여러 테이블을 조인하여 필요한 데이터만 젖ㅇ하고 빠른 확인을 위해 사용.
...
-- 두 번째 컬럼인 'name'은 가상열(virtual column)이기 떄문에 INSERT가 안됩니다.
...
--  원본 테이블의 NULL을 허용하지 않는 컬럼 떄문에 들어갈 수 없습니다.

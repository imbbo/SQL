...
*/
SELECT e.first_name, e.last_name, e.department_id, j.job_id
FROM employees e
INNER JOIN jobs j
...
SELECT e.employee_id, e.first_name, e.salary, e.job_id, d.department_name, loc.city
FROM employees e
...
---------------------------------------------------
SELECT
    e.employee_id, e.first_name, e.salaty,
    d.department_name,
    loc.city
FROM employees e
JOIN departments d
